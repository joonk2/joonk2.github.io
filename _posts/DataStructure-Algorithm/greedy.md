...
tags: [DataStructure, Algorithm, python, Greedy]
toc: true
toc_sticky: true
date: 2024-01-10
---
...
![Desktop View](assets/img/data-algm/greedy/1.PNG)

가장 첫번째 길목에서 `슈퍼 나뭇잎`이 4점이라 저걸 바로 택했다.

![Desktop View](assets/img/data-alg/greedy/2.PNG)

슈퍼 나뭇잎을 택한 상황에서 그다음 제일 좋은 것을 비교해보니 `불꽃`이 `최적의 해` 더라
...
이 경우에는 마리오가 `버섯(2점) → 별(5점)`으로 가는게 전체 최적해가 된다.
