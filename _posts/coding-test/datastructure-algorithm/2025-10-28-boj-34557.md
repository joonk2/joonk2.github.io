---
title:  "[백준 34557] 횃불이의 모험 Java 풀이"
description: "백준 34557번 횃불이의 모험 문제를 Java로 해결한 풀이입니다. 구현 알고리즘을 활용하여 키보드 이벤트(Down, Stay, Up)를 시뮬레이션하고 횃불이의 이동을 구현하는 방법을 설명합니다."
layout: post
...
## 2. 문제 설명
### [boj-34557-횃불이의 모험](https://www.acmicpc.net/problem/34557)
(제한시간 -> 1초)
...
아래 Java 코드는 구현 관점에서 접근한 핵심 풀이입니다. 입력 조건과 시간·공간 복잡도를 함께 고려하여 불필요한 연산을 줄이는 방향으로 설계했습니다.
...
위 구현은 [백준/Java] 34557번 횃불이의 모험 풀이 - BFS 알고리즘의 제약 조건을 만족하도록 자료구조 선택과 반복 범위를 최적화한 결과입니다.
