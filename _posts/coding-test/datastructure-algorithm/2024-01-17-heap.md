---
title:  "Heap"
description: "힙(Heap) 자료구조의 개념과 동작 원리를 설명합니다. 완전 이진트리 기반의 최소 힙과 최대 힙의 특징을 이해하고, Python의 heapq 라이브러리를 활용한 구현 방법을 학습합니다."
layout: post
...
![`1)` 데이터 삽입 알고리즘 문제 풀이 참고 이미지](/assets/img/data-alg/heap/0.png)

### `2)` 데이터 삭제

![`2)` 데이터 삭제 알고리즘 문제 풀이 참고 이미지](/assets/img/data-alg/heap/1.png)
...
![결과: ['1', '3', '2', '5', '6', '4'] 알고리즘 문제 풀이 참고 이미지](/assets/img/data-alg/heap/2.png)
...
![결과: ['2', '3', '4', '5', '6'] 알고리즘 문제 풀이 참고 이미지](/assets/img/data-alg/heap/3.png)
