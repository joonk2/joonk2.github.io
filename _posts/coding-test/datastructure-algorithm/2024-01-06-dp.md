---
title:  "DP"
description: "동적 계획법(Dynamic Programming)의 개념과 특징을 설명합니다. 메모이제이션(Memoization)과 타뷸레이션(Tabulation) 방식을 통해 피보나치 수열 문제를 효율적으로 해결하는 방법을 학습합니다."
layout: post
...
![DP 알고리즘 상태 전이 및 최적화 과정](/assets/img/data-alg/dp/0.png)

## x = 5 일 때

![x = 5 일 때 알고리즘 문제 풀이 참고 이미지](/assets/img/data-alg/dp/1.png)
...
![4. dp(동적계획법)을 활용한 한계 극복 알고리즘 문제 풀이 참고 이미지](/assets/img/data-alg/dp/2.png)
