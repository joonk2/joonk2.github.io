---
title:  "[백준 15501] 부당한 퍼즐 Java 풀이"
description: "백준 15501번 부당한 퍼즐 문제를 Java로 해결한 풀이입니다. 구현 알고리즘을 활용하여 시계방향과 반시계방향 회전을 통해 원형 배열의 회전 가능성을 확인하는 방법을 설명합니다."
layout: post
...
![알고리즘 문제 풀이 참고 다이어그램](/assets/img/boj/boj_11501_1.jpg)
