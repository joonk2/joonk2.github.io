---
title:  "DFS && BFS"
description: "깊이 우선 탐색(DFS)과 너비 우선 탐색(BFS) 알고리즘의 차이점과 구현 방법을 설명합니다. 백준 1260번 문제를 통해 그래프 탐색 방법을 이해하고, Stack과 Queue를 활용한 구현 방법을 학습합니다."
layout: post
...
![알고리즘 문제 풀이 참고 다이어그램](/assets/img/data-alg/graph/graph-1.png)
