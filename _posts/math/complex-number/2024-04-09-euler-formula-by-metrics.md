...
![선형대수·수학 개념 설명: 우변으로부터](/assets/img/math/ComplexNumber/Euler_Formula_by_metrics/1.png)
<br>
...
![선형대수·수학 개념 설명: <span style="color:pink">**잠시 참고!**</span>](/assets/img/math/ComplexNumber/Euler_Formula_by_metrics/2.png)
<br><br>
...
![선형대수·수학 개념 설명: <span style="color:red">**n=1**</span>](/assets/img/math/ComplexNumber/Euler_Formula_by_metrics/3.png)
<br><br>
...
![수학 개념 설명 다이어그램](/assets/img/math/ComplexNumber/Euler_Formula_by_metrics/4.png)
<br><br><br>

## <span style="color:red">**n=3**</span>
![선형대수·수학 개념 설명: <span style="color:red">**n=3**</span>](/assets/img/math/ComplexNumber/Euler_Formula_by_metrics/5.png)
<br><br><br>
