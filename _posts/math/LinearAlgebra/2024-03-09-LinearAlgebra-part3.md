...
임의의 실수k, m은 F라는 실수집합에 속한다. <br>
S라는 공간은 `R**2`[2차원 실수벡터 공간(aka 2차원 유클리드 공간)]을 생성하더라 <br>
여기서의 핵심은 S인 임의의 벡터집합 (1,0), (0,1)로 실수집합 안의 임의의 실수인 k,m 을 이용해 모든 선형결합 가능하다는 것이다
<br><br>

## 2-3) 선형독립
이 개념은 특히 응용분야에서 중요하다 <br>
왜? --> 이런 정보들은 계산에 복잡함의 정도를 미리 예견해줌
