...
![선형대수·수학 개념 설명: 1-1. 연속함수 vs 불연속함수](/assets/img/math/calculus/roll-avg-Lhopital/1.png) <br>

자 그러면 함수가 연속일 조건은? 3가지다 <br>

### (1) 함수 f(x)에 대해 x=a에서 함숫값 f(a)가 존재해야 한다
![선형대수·수학 개념 설명: (1) 함수 f(x)에 대해 x=a에서 함숫값 f(a)가 존재해야 한다](/assets/img/math/calculus/roll-avg-Lhopital/2.png) <br>
...
![선형대수·수학 개념 설명: (2) x=a에서 극한값 존재($$\lim_{x\to a}f(x)$$가 존재)](/assets/img/math/calculus/roll-avg-Lhopital/3.png) <br>
...
### (3) `함숫값 = 극한값` 일 것
![선형대수·수학 개념 설명: (3) `함숫값 = 극한값` 일 것](/assets/img/math/calculus/roll-avg-Lhopital/4.png) <br>
...
![수학 개념 설명 다이어그램](/assets/img/math/calculus/roll-avg-Lhopital/5.png)
...
![선형대수·수학 개념 설명: 3. 평균값 정리](/assets/img/math/calculus/roll-avg-Lhopital/6.png) <br>
...
![선형대수·수학 개념 설명: **<font color='red'>sol</font>**](/assets/img/math/calculus/roll-avg-Lhopital/7.png) <br>
...
![선형대수·수학 개념 설명: 4. **L'hopital's theorem**](/assets/img/math/calculus/roll-avg-Lhopital/8.png) <br>
