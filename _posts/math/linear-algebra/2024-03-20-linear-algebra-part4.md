...
# *참고
![선형대수·수학 개념 설명: *참고](/assets/img/math/LinearAlgebra/part4/1.png) <br><br>
![선형대수·수학 개념 설명: *참고](/assets/img/math/LinearAlgebra/part4/2.png)
<br>
...
![선형대수·수학 개념 설명: 선형사상(L):](/assets/img/math/LinearAlgebra/part4/3.png)
<br>
...
![수학 개념 설명 다이어그램](/assets/img/math/LinearAlgebra/part4/4.png)
...
![수학 개념 설명 다이어그램](/assets/img/math/LinearAlgebra/part4/5.png)
<br>
...
![수학 개념 설명 다이어그램](/assets/img/math/LinearAlgebra/part4/6.png)
...
![선형대수·수학 개념 설명: 왜 $$3v_1,v_2,2v_3$$이 아니고 대문자인 $$3V_1, V_2, 2V_3$$이냐?](/assets/img/math/LinearAlgebra/part4/7.png)
$$B_v \Rightarrow B_w$$
...
### 3번 설명
![선형대수·수학 개념 설명: 3번 설명](/assets/img/math/LinearAlgebra/part4/8.png)
![선형대수·수학 개념 설명: 3번 설명](/assets/img/math/LinearAlgebra/part4/9.png)
...
### 요약본
![선형대수·수학 개념 설명: 요약본](/assets/img/math/LinearAlgebra/part4/10.png)

<br><br><br>

### A to Z
![선형대수·수학 개념 설명: A to Z](/assets/img/math/LinearAlgebra/part4/11.png)
<br>

![선형대수·수학 개념 설명: A to Z](/assets/img/math/LinearAlgebra/part4/12.png)
<br>

![선형대수·수학 개념 설명: A to Z](/assets/img/math/LinearAlgebra/part4/13.png)
<br><br><br><br>

## 3-2 비둘기집 정리
![선형대수·수학 개념 설명: 3-2 비둘기집 정리](/assets/img/math/LinearAlgebra/part4/14.png)
<br>

![선형대수·수학 개념 설명: 3-2 비둘기집 정리](/assets/img/math/LinearAlgebra/part4/15.png)
<br>

![선형대수·수학 개념 설명: 3-2 비둘기집 정리](/assets/img/math/LinearAlgebra/part4/16.png)
<br><br><br>

![수학 개념 설명 다이어그램](/assets/img/math/LinearAlgebra/part4/17.png)
<br>
...
# 4. 예제 (3개)
## 4-1 선형사상 증명
![선형대수·수학 개념 설명: 4-1 선형사상 증명](/assets/img/math/LinearAlgebra/part4/19.png)

```python
*이 문제를 풀기 위해서는 가산성, 동차성을 증명해야한다
```
![선형대수·수학 개념 설명: 4-1 선형사상 증명](/assets/img/math/LinearAlgebra/part4/20.png)

## 4-2 동형사상 증명
![선형대수·수학 개념 설명: 4-2 동형사상 증명](/assets/img/math/LinearAlgebra/part4/21.png)
...
```
![선형대수·수학 개념 설명: 4-2 동형사상 증명](/assets/img/math/LinearAlgebra/part4/22.png)
![수학 개념 설명 다이어그램](/assets/img/math/LinearAlgebra/part4/23.png)
![수학 개념 설명 다이어그램](/assets/img/math/LinearAlgebra/part4/24.png)
<br><br><br>

## 4-3 선형사상
![선형대수·수학 개념 설명: 4-3 선형사상](/assets/img/math/LinearAlgebra/part4/25.png)
![선형대수·수학 개념 설명: 4-3 선형사상](/assets/img/math/LinearAlgebra/part4/26.png)
![선형대수·수학 개념 설명: 4-3 선형사상](/assets/img/math/LinearAlgebra/part4/27.png)
<br><br><br>
