...
음악을 다운로드받고 나는 gitlab에 따로 또 등록하였다. <br>
우리가 필요한 건 음악의 raw 주소다. <br>
깃허브나 깃랩에 올린 음악파일.wav 혹은 mp3은 용량이 커서 view raw를 누르면 다운로드 되는데 당황하지말고 일단 나의 글을 천천히 잘 읽어보자 <br>
...
sidebar, topbar, 뭐 아래쪽 부분 아무대나 추가하는 것은 여러분의 선택이다 <br>
...
처음 홈페이지 들어올 때 자동 재생을 보안규정때문에 못한다더라
대신 내부 페이지를 눌렀을 때 음악 자동재생은 가능하다하네 <br>
<br><br>
