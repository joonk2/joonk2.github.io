---
title:  "[깃허브 블로그] Jekyll 테마로 블로그 만드는 법 - 3편 최종 배포"
layout: post
categories: [etc, blog] 
...
![Jekyll 테마로 블로그 만드는 법 - 3편 최종 배포 관련 참고 이미지](/assets/img/2022-08-14/0.PNG)
...
![Jekyll 테마로 블로그 만드는 법 - 3편 최종 배포 관련 참고 이미지](/assets/img/2022-08-14/2-1.PNG)
...
![Jekyll 테마로 블로그 만드는 법 - 3편 최종 배포 관련 참고 이미지](/assets/img/2022-08-14/1.PNG)
<br>
...
![Jekyll 테마로 블로그 만드는 법 - 3편 최종 배포 관련 참고 이미지](/assets/img/2022-08-14/2.PNG)
...
![Jekyll 테마로 블로그 만드는 법 - 3편 최종 배포 관련 참고 이미지](/assets/img/2022-08-14/4.PNG)
...
![Jekyll 테마로 블로그 만드는 법 - 3편 최종 배포 관련 참고 이미지](/assets/img/2022-08-14/5.PNG)

<br>
<br>

저는 이미 완료했기에 아래처럼 `joonhwan2/joonhwan2.github.io`로 나옵니다\
여러분들은 select repositories 클릭해서 연동하시면 됩니다\
그리고 조금 내려가시다 보면 아래와 같은 화면이 나옵니다

<br>
<br>

![Jekyll 테마로 블로그 만드는 법 - 3편 최종 배포 관련 참고 이미지](/assets/img/2022-08-14/6.PNG)
...
![Jekyll 테마로 블로그 만드는 법 - 3편 최종 배포 관련 참고 이미지](/assets/img/2022-08-14/8.PNG)
...
- [👉 다음 단계: 구글 검색 노출 설정하기](https://joonk2.github.io/posts/2022/08/14/google-search-engine/)
